...
const mano_p1 = new Mesa('Mesa P1', mazoMezclado[0], mazoMezclado[1], mazoMezclado[indices[0]], mazoMezclado[indices[1]], mazoMezclado[indices[2]], mazoMezclado[indices[3]], mazoMezclado[indices[4]]);
const mano_p2 = new Mesa('Mesa P2', mazoMezclado[2], mazoMezclado[3], mazoMezclado[indices[0]], mazoMezclado[indices[1]], mazoMezclado[indices[2]], mazoMezclado[indices[3]], mazoMezclado[indices[4]]);
const mano_p3 = new Mesa('Mesa P3', mazoMezclado[4], mazoMezclado[5], mazoMezclado[indices[0]], mazoMezclado[indices[1]], mazoMezclado[indices[2]], mazoMezclado[indices[3]], mazoMezclado[indices[4]]);
...
const p1 = new Player('P1', validar, puntaje);
...
const p2 = new Player('P2', validar2, puntaje2);
...
const p3 = new Player('P3', validar3, puntaje3);
